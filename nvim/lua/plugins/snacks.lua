            ...
            dashboard = {
                ...
                sections = {
                    -- display an image
                    {
                        section = "terminal",
                        cmd =
                        "chafa $HOME/Wallpapers/5.jpg --format symbols --symbols vhalf --size 60x17 --stretch; sleep .1",
                        padding = 1,
                ...
                preset = {
                    ...
                    keys = {
                        ...
                        -- keymappings for finding system configuration files
                        {
                            ...
                            action =
                            ":lua Snacks.dashboard.pick('files', {cwd = vim.fn.expand('$HOME/.config'), layout = 'telescope' })",
                        },
