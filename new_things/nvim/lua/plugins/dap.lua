-- NOTE: original configuration from 'https://www.youtube.com/watch?v=cxpWjlNXeQA'
-- then I when ahead and customised the keymappings so that its the same as LazyVim
